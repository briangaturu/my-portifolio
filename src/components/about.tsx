...
export const techStack = [
  ...
  {
    name: "Netlify",
    color: "from-teal-400/20 to-teal-300/5 border-teal-400/30 text-teal-600 dark:text-teal-300",
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="#05BDBA">
        <path d="M16.934 8.519a1.044 1.044 0 01.303.23l2.349-1.045-2.192-2.171-.491 2.954zM8.3 7.044L6.83 8.52l.49 2.942 2.17-2.17L8.3 7.044zM12.413 2.783L8.3 7.044l1.19 1.248h4.998l1.19-1.248-3.264-4.26zM3 13.7l1.97.432L3 12.21V13.7zM21 12.22l-1.97 1.912 1.97-.43V12.22zM11.584 21.217L7.413 17.03l-3.624.76 7.795 3.427zM14.99 21.216l4.17-3.424-3.624-.76-4.17 4.184h3.624z" />
      </svg>
    ),
  },
  {
  ...
  return (
    <>
      ...
      >
        ...
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] rounded-full bg-indigo-400/10 dark:bg-indigo-600/10 blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 gap-4">
            {techStack.map((tech, i) => (
              ...
              >
                ...
                <span className="shrink-0" aria-hidden="true">{tech.icon}</span>
                <span className="font-semibold text-sm">{tech.name}</span>
                <span className="absolute top-2 right-2 text-[10px] font-mono opacity-0 group-hover:opacity-50 transition-opacity">
                  {"</>"}
                </span>
              </motion.div>
            ))}
          ...
          >
            ...
            <span className="text-xs text-gray-500 dark:text-gray-500 font-mono tracking-widest uppercase">Always Learning More</span>
            <div className="h-px flex-1 bg-linear-to-r from-transparent via-cyan-400/30 to-transparent" />
          </motion.div>
        </div>
      </section>
